...
SimpleGraph = function(elemid, options) {
  ...
  this.options.dataX = options.dataX || [0];
  this.options.dataY = options.dataY || [0];

  this.options.xmax = options.xmax || d3.max(this.options.dataX);
  this.options.xmin = options.xmin || d3.min(this.options.dataX);
  this.options.ymax = options.ymax || d3.max(this.options.dataY);
  this.options.ymin = options.ymin || d3.min(this.options.dataY);
  ...
  this.points = this.options.dataX.map(function(el,i){
    return {x: el, y: dataY[i] };
  });
